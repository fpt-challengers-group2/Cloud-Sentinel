...
- [Cloud-Sentinel – SOAR System for Critical Infrastructure on AWS](#cloud-sentinel--soar-system-for-critical-infrastructure-on-aws)
  ...
  - [5. NGUỒN LỰC VÀ ƯỚC TÍNH CHI PHÍ](#5-nguồn-lực-và-ước-tính-chi-phí)
  ...
  - [6. NGHIỆM THU](#6-nghiệm-thu)
    - [6.1. Gói bàn giao](#61-gói-bàn-giao)
    - [6.2. Quy trình nghiệm thu](#62-quy-trình-nghiệm-thu)
    - [6.3. Điều kiện từ chối](#63-điều-kiện-từ-chối)
...
## 5. NGUỒN LỰC VÀ ƯỚC TÍNH CHI PHÍ
